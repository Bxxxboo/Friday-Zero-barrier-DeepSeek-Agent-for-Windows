...
(function () {
  ...
  const STRINGS = {
    zh: {
      ...
      "appearance.title": "外观",
      "appearance.desc": "界面语言、主题、字号与默认交互模式，保存后立即生效。",
      "appearance.language": "界面语言",
      "appearance.theme": "主题",
      "appearance.fontSize": "字体大小",
      "appearance.defaultMode": "默认交互模式",
      "appearance.modeHint": "输入框上方可随时切换；此处为启动时的默认模式",
      "lang.zh": "简体中文",
      "lang.en": "English",
      "theme.dark": "深色（夜间）",
      "theme.light": "浅色（日间）",
    ...
    en: {
      ...
      "appearance.desc": "Language, theme, font size, and default interaction mode. Takes effect after save.",
      "appearance.language": "Language",
      "appearance.theme": "Theme",
      "appearance.fontSize": "Font size",
      "appearance.defaultMode": "Default interaction mode",
      "appearance.modeHint": "Switch anytime above the input; this is the startup default",
      "lang.zh": "简体中文",
      "lang.en": "English",
      "theme.dark": "Dark",
      "theme.light": "Light",
      ...
      "logs.title": "Logs",
      "logs.desc": "View runtime logs and diagnostics for troubleshooting.",
